...
ProjectName <- "PANICI_Melanoma_PreTreatment"

Expression_Matrix_File <- "Input/PANICI_Skin_Pre_Expression.zip"

Meta_Data_File <- "Input/PANICI_Skin_Pre_Meta.txt"

Meta_Data_Param_File <- "Input/PANICI_Skin_Pre_Meta_Params.txt"
...
CIBERSORT_Script <- "Path/To/cibersort/CIBERSORT.R"
# LM22 path and file name
LM22_File <- "Path/To/cibersort/LM22.txt"
